...
Integración de Servientrega como método de envio para woocommerce podrá usar los servicios: generacion de guias,
...
La reciente versión esta limitada podrá adquirir la paga con todas las funciones que brinda Servientrega

== Screenshots ==

1. Añadir el método en zonas de envío screenshot-1.png
...
= 2.0.3 =
* Added wp_nonce_field
= 2.0.4 =
* Added freight
= 2.0.5 =
* Added sanitize_text_field
= 2.0.6 =
* Added sanitize_text_field
